...
`,
  ...
  // AWS Practice
  {
    ...
    content: [
      {
        subMenu: "Unknown Billing Issue: Resolved" as "Comments",
        items: [
          {
            text: [
      ...
      {
        subMenu: "Account no longer needed" as "Objective",
        items: [
          {
            text: [
      ...
      {
        subMenu: "Studied: Storage Gateway" as "Objective",
        items: [
          {
            text: [
        ...
        items: [
          {
            text: [
              ...
              "GCC is portable and run on many operating systems, including Linux, most other Unix-like systems, and Windows. It produces machine items for many architectures. GCC by default compiles to machine items for on the architecture of the machine it is running on.",
              "How to invoke GCC:",
            ],
            language: "powershell",
            code: `gcc <input filename> -o <output filename> // windows auto appends .exe to the output file`,
          },
          {
...
#include <stdio.h> // includes the standard input/output library
          ...
          {
            text: [
              "When you use the #include directive, the contents of a header file are literally copied into the source items file by the preprocessor before the actual compilation begins.",
...
// Searching and sorting (qsort, bsearch)
          ...
          },
          {
            text: [
              ...
              "The main function in C is whats invoked the items is compiled and ran",
            ],
            language: "c",
            code: `
#include <stdio.h>
...
export default Data;
      ...
      },
      {
        ...
        items: [
          {
            text: [
              "There is probably a lot more I can say about the initial development of this website but it's more or less just standard TypeScript, vanilla React, and TailwindCSS. Any updates I make to the website will probably be off the record and not included in the daily logs as I move forward because I assume that as I begin to add more content to the website, I'll be able to better understand what features I need to add and what I need to change.",
              "Rather than starting new projects immediately, my focus is finishing some of the projects I've already started and getting them to a state where I can add them to my portfolio. So some of the content I'll be adding to the website will be from those projects at first while I get into the groove of adding daily content.",
            ],
          },
        ],
      },
